...
public:
	...
	static void GetPerObjectConfigObjects(class UClass* SearchClass, class UObject* ObjectOuter, int32_t MaxResults, class UObject*& OutObject);
	...
	static class FString Localize(class FString SectionName, class FString KeyName, class FString PackageName, unsigned long bOptional);
	...
	static class FString JoinArrayQWord(class FString delim, unsigned long bIgnoreBlanks, TArray<uint64_t>& QWordArray);
	static class FString JoinArrayInt(class FString delim, unsigned long bIgnoreBlanks, TArray<int32_t>& IntArray);
	static class FString JoinArrayName(class FString delim, unsigned long bIgnoreBlanks, TArray<struct FName>& NameArray);
	static class FString JoinArrayStr(class FString delim, unsigned long bIgnoreBlanks, TArray<class FString>& StringArray);
	static void JoinArray(class FString delim, unsigned long bIgnoreBlanks, TArray<class FString>& StringArray, class FString& out_Result);
	...
	static struct FVector CalculateGravityPosition(struct FVector Location, struct FVector Velocity, float Gravity, float Time, struct FVector GravityDirection);
...
class UGroup_ORS : public UObject
{
public:
...
public:
	...
	static void AllCDOs(class UClass* BaseClass, unsigned long bIncludeAbstract, class UObject*& OutCDO);
...
public:
	...
	static bool LoadFileToBytes(class FString Path, int32_t StartOffset, int32_t Length, TArray<uint8_t>& OutBytes);
...
{
public:
	class UFuncton* Function; // 0x00C8 (0x0008)
...
public:
	...
	unsigned long                                      Matchmaking : 1;                               // 0x0068 (0x0004) [0x0000000040000000] [0x00000008] (CPF_EditInlineNotify)
	unsigned long                                      PrivateMatch : 1;                              // 0x0068 (0x0004) [0x0000000040000000] [0x00000010] (CPF_EditInlineNotify)
	unsigned long                                      SplitscreenMatch : 1;                          // 0x0068 (0x0004) [0x0000000040000000] [0x00000020] (CPF_EditInlineNotify)
	unsigned long                                      SplitscreenJoin : 1;                           // 0x0068 (0x0004) [0x0000000040000000] [0x00000040] (CPF_EditInlineNotify)
	unsigned long                                      SeasonMode : 1;                                // 0x0068 (0x0004) [0x0000000040000000] [0x00000080] (CPF_EditInlineNotify)
	unsigned long                                      Tutorial : 1;                                  // 0x0068 (0x0004) [0x0000000040000000] [0x00000100] (CPF_EditInlineNotify)
	unsigned long                                      Garage : 1;                                    // 0x0068 (0x0004) [0x0000000040000000] [0x00000200] (CPF_EditInlineNotify)
	unsigned long                                      Options : 1;                                   // 0x0068 (0x0004) [0x0000000040000000] [0x00000400] (CPF_EditInlineNotify)
	unsigned long                                      ReplaySaves : 1;                               // 0x0068 (0x0004) [0x0000000040000000] [0x00000800] (CPF_EditInlineNotify)
	unsigned long                                      MainMenu : 1;                                  // 0x0068 (0x0004) [0x0000000040000000] [0x00001000] (CPF_EditInlineNotify)
	unsigned long                                      MidgameMenu : 1;                               // 0x0068 (0x0004) [0x0000000040000000] [0x00002000] (CPF_EditInlineNotify)
	unsigned long                                      Party : 1;                                     // 0x0068 (0x0004) [0x0000000040000000] [0x00004000] (CPF_EditInlineNotify)
	unsigned long                                      PsyNetParty : 1;                               // 0x0068 (0x0004) [0x0000000040000000] [0x00008000] (CPF_EditInlineNotify)
	unsigned long                                      Achievements : 1;                              // 0x0068 (0x0004) [0x0000000040000000] [0x00010000] (CPF_EditInlineNotify)
	unsigned long                                      Stats : 1;                                     // 0x0068 (0x0004) [0x0000000040000000] [0x00020000] (CPF_EditInlineNotify)
	unsigned long                                      Leaderboards : 1;                              // 0x0068 (0x0004) [0x0000000040000000] [0x00040000] (CPF_EditInlineNotify)
	unsigned long                                      XP : 1;                                        // 0x0068 (0x0004) [0x0000000040000000] [0x00080000] (CPF_EditInlineNotify)
	unsigned long                                      Chat : 1;                                      // 0x0068 (0x0004) [0x0000000040000000] [0x00100000] (CPF_EditInlineNotify)
	unsigned long                                      TrainingDifficulties : 1;                      // 0x0068 (0x0004) [0x0000000040000000] [0x00200000] (CPF_EditInlineNotify)
	unsigned long                                      Spectator : 1;                                 // 0x0068 (0x0004) [0x0000000040000000] [0x00400000] (CPF_EditInlineNotify)
	unsigned long                                      CrossPlatformPrivateMatch : 1;                 // 0x0068 (0x0004) [0x0000000040000000] [0x00800000] (CPF_EditInlineNotify)
	unsigned long                                      Lan : 1;                                       // 0x0068 (0x0004) [0x0000000040000000] [0x01000000] (CPF_EditInlineNotify)
	unsigned long                                      PlayerReporting : 1;                           // 0x0068 (0x0004) [0x0000000040000000] [0x02000000] (CPF_EditInlineNotify)
	unsigned long                                      OnlineServices : 1;                            // 0x0068 (0x0004) [0x0000000040000000] [0x40000000] (CPF_EditInlineNotify)
	unsigned long                                      RemoveCrossPlatformProducts : 1;               // 0x0068 (0x0004) [0x0000000040000000] [0x80000000] (CPF_EditInlineNotify)
	unsigned long                                      ProductValidation : 1;                         // 0x006C (0x0004) [0x0000000040000000] [0x00000001] (CPF_EditInlineNotify)
	unsigned long                                      MapPrefs : 1;                                  // 0x006C (0x0004) [0x0000000040000000] [0x00000002] (CPF_EditInlineNotify)
	unsigned long                                      Tournaments : 1;                               // 0x006C (0x0004) [0x0000000040000000] [0x00000008] (CPF_EditInlineNotify)
	unsigned long                                      PreMatchLobby : 1;                             // 0x006C (0x0004) [0x0000000040000000] [0x00000010] (CPF_EditInlineNotify)
	unsigned long                                      Challenges : 1;                                // 0x006C (0x0004) [0x0000000040000000] [0x00000020] (CPF_EditInlineNotify)
	unsigned long                                      AntiAddiction : 1;                             // 0x006C (0x0004) [0x0000000040000000] [0x00000040] (CPF_EditInlineNotify)
	unsigned long                                      TrainingEditor : 1;                            // 0x006C (0x0004) [0x0000000040000000] [0x00000080] (CPF_EditInlineNotify)
	unsigned long                                      VoiceChat : 1;                                 // 0x006C (0x0004) [0x0000000040000000] [0x00000100] (CPF_EditInlineNotify)
	unsigned long                                      SplitScreen : 1;                               // 0x006C (0x0004) [0x0000000040000000] [0x00000200] (CPF_EditInlineNotify)
	unsigned long                                      Clubs : 1;                                     // 0x006C (0x0004) [0x0000000040000000] [0x00000400] (CPF_EditInlineNotify)
	unsigned long                                      FilterContent : 1;                             // 0x006C (0x0004) [0x0000000040000000] [0x00000800] (CPF_EditInlineNotify)
	unsigned long                                      EncryptContent : 1;                            // 0x006C (0x0004) [0x0000000040000000] [0x00001000] (CPF_EditInlineNotify)
	unsigned long                                      EsportsCamera : 1;                             // 0x006C (0x0004) [0x0000000040000000] [0x00008000] (CPF_EditInlineNotify)
	unsigned long                                      OnlineXP : 1;                                  // 0x006C (0x0004) [0x0000000040000000] [0x00010000] (CPF_EditInlineNotify)
	unsigned long                                      ClanforgeReservation : 1;                      // 0x006C (0x0004) [0x0000000040000000] [0x00040000] (CPF_EditInlineNotify)
	unsigned long                                      UserSettingObserver : 1;                       // 0x006C (0x0004) [0x0000000040000000] [0x00080000] (CPF_EditInlineNotify)
	unsigned long                                      Metrics : 1;                                   // 0x006C (0x0004) [0x0000000040000000] [0x00100000] (CPF_EditInlineNotify)
	unsigned long                                      EOSMetrics : 1;                                // 0x006C (0x0004) [0x0000000040000000] [0x00200000] (CPF_EditInlineNotify)
	unsigned long                                      MusicPlaylistSelection : 1;                    // 0x006C (0x0004) [0x0000000040000000] [0x00400000] (CPF_EditInlineNotify)
	unsigned long                                      SpecialEvents : 1;                             // 0x006C (0x0004) [0x0000000040000000] [0x00800000] (CPF_EditInlineNotify)
	unsigned long                                      PlayerBannerCustomization : 1;                 // 0x006C (0x0004) [0x0000000040000000] [0x01000000] (CPF_EditInlineNotify)
	unsigned long                                      SecureUDP : 1;                                 // 0x006C (0x0004) [0x0000000040000000] [0x02000000] (CPF_EditInlineNotify)
	unsigned long                                      PsyNet : 1;                                    // 0x006C (0x0004) [0x0000000040000000] [0x04000000] (CPF_EditInlineNotify)
	unsigned long                                      OnlinePlayerStorage : 1;                       // 0x006C (0x0004) [0x0000000040000000] [0x08000000] (CPF_EditInlineNotify)
	unsigned long                                      LocalSaveData : 1;                             // 0x006C (0x0004) [0x0000000040000000] [0x10000000] (CPF_EditInlineNotify)
	unsigned long                                      CrowdV2 : 1;                                   // 0x006C (0x0004) [0x0000000040000000] [0x20000000] (CPF_EditInlineNotify)
	unsigned long                                      ChatBan : 1;                                   // 0x006C (0x0004) [0x0000000040000000] [0x40000000] (CPF_EditInlineNotify)
	unsigned long                                      BacktraceCrashDumps : 1;                       // 0x006C (0x0004) [0x0000000040000000] [0x80000000] (CPF_EditInlineNotify)
	unsigned long                                      SpotifyButton : 1;                             // 0x0070 (0x0004) [0x0000000040000000] [0x00000001] (CPF_EditInlineNotify)
	unsigned long                                      RocketPass : 1;                                // 0x0070 (0x0004) [0x0000000040000000] [0x00000002] (CPF_EditInlineNotify)
	unsigned long                                      SeasonRewards : 1;                             // 0x0070 (0x0004) [0x0000000040000000] [0x00000008] (CPF_EditInlineNotify)
	unsigned long                                      FaceIt : 1;                                    // 0x0070 (0x0004) [0x0000000040000000] [0x00000010] (CPF_EditInlineNotify)
	unsigned long                                      KnockOut : 1;                                  // 0x0070 (0x0004) [0x0000000040000000] [0x00000020] (CPF_EditInlineNotify)
	unsigned long                                      OnlinePlayerTitles : 1;                        // 0x0070 (0x0004) [0x0000000040000000] [0x00000040] (CPF_EditInlineNotify)
	unsigned long                                      RestrictByRegion : 1;                          // 0x0070 (0x0004) [0x0000000040000000] [0x00000080] (CPF_EditInlineNotify)
	unsigned long                                      FirstTimeExperience : 1;                       // 0x0070 (0x0004) [0x0000000040000000] [0x00000200] (CPF_EditInlineNotify)
	unsigned long                                      RLBot : 1;                                     // 0x0070 (0x0004) [0x0000000040000000] [0x00000400] (CPF_EditInlineNotify)
	unsigned long                                      UserBugReport : 1;                             // 0x0070 (0x0004) [0x0000000040000000] [0x00000800] (CPF_EditInlineNotify)
	unsigned long                                      SteamInput : 1;                                // 0x0070 (0x0004) [0x0000000040000000] [0x00001000] (CPF_EditInlineNotify)
	unsigned long                                      ReplayFXControls : 1;                          // 0x0070 (0x0004) [0x0000000040000000] [0x00020000] (CPF_EditInlineNotify)
	unsigned long                                      ESportsShop : 1;                               // 0x0070 (0x0004) [0x0000000040000000] [0x00040000] (CPF_EditInlineNotify)
	unsigned long                                      DynamicRangeAudioSettings : 1;                 // 0x0070 (0x0004) [0x0000000040000000] [0x00400000] (CPF_EditInlineNotify)
	unsigned long                                      AutoTour : 1;                                  // 0x0070 (0x0004) [0x0000000040000000] [0x00800000] (CPF_EditInlineNotify)
	unsigned long                                      QuickPlay : 1;                                 // 0x0070 (0x0004) [0x0000000040000000] [0x01000000] (CPF_EditInlineNotify)
	unsigned long                                      NewsPanelV2 : 1;                               // 0x0070 (0x0004) [0x0000000040000000] [0x02000000] (CPF_EditInlineNotify)
	unsigned long                                      Blueprints : 1;                                // 0x0070 (0x0004) [0x0000000040000000] [0x04000000] (CPF_EditInlineNotify)
	unsigned long                                      GodBall : 1;                                   // 0x0070 (0x0004) [0x0000000040000000] [0x08000000] (CPF_EditInlineNotify)
	unsigned long                                      RocketBucks : 1;                               // 0x0070 (0x0004) [0x0000000040000000] [0x20000000] (CPF_EditInlineNotify)
	unsigned long                                      DiscordRichPresence : 1;                       // 0x0074 (0x0004) [0x0000000040000000] [0x00000002] (CPF_EditInlineNotify)
	unsigned long                                      SupportACreator : 1;                           // 0x0074 (0x0004) [0x0000000040000000] [0x00000004] (CPF_EditInlineNotify)
	unsigned long                                      CinematicIntro : 1;                            // 0x0074 (0x0004) [0x0000000040000000] [0x00000008] (CPF_EditInlineNotify)
	unsigned long                                      TinyCrowd : 1;                                 // 0x0074 (0x0004) [0x0000000040000000] [0x00000010] (CPF_EditInlineNotify)
	unsigned long                                      CrumbTrail : 1;                                // 0x0074 (0x0004) [0x0000000040000000] [0x00000020] (CPF_EditInlineNotify)
	unsigned long                                      EpicGameStoreBuild : 1;                        // 0x0074 (0x0004) [0x0000000040000000] [0x00000040] (CPF_EditInlineNotify)
	unsigned long                                      XPGatedPlaylists : 1;                          // 0x0074 (0x0004) [0x0000000040000000] [0x00000080] (CPF_EditInlineNotify)
	unsigned long                                      TradeInV2 : 1;                                 // 0x0074 (0x0004) [0x0000000040000000] [0x00000200] (CPF_EditInlineNotify)
	unsigned long                                      Football : 1;                                  // 0x0074 (0x0004) [0x0000000040000000] [0x00000400] (CPF_EditInlineNotify)
	unsigned long                                      RumbleSelection : 1;                           // 0x0074 (0x0004) [0x0000000040000000] [0x00000800] (CPF_EditInlineNotify)
	unsigned long                                      UndersizedParty : 1;                           // 0x0074 (0x0004) [0x0000000040000000] [0x00001000] (CPF_EditInlineNotify)
	unsigned long                                      StreamerSafeAudio : 1;                         // 0x0074 (0x0004) [0x0000000040000000] [0x00002000] (CPF_EditInlineNotify)
	unsigned long                                      FreeplayCommands : 1;                          // 0x0074 (0x0004) [0x0000000040000000] [0x00004000] (CPF_EditInlineNotify)
	unsigned long                                      Rumble_BM : 1;                                 // 0x0074 (0x0004) [0x0000000040000000] [0x00008000] (CPF_EditInlineNotify)
	unsigned long                                      PlayerReportingV2 : 1;                         // 0x0074 (0x0004) [0x0000000040000000] [0x00010000] (CPF_EditInlineNotify)
	unsigned long                                      BlogScheduling : 1;                            // 0x0074 (0x0004) [0x0000000040000000] [0x00020000] (CPF_EditInlineNotify)
	unsigned long                                      EOSVoice : 1;                                  // 0x0074 (0x0004) [0x0000000040000000] [0x00040000] (CPF_EditInlineNotify)
	unsigned long                                      QuickPostMatchRequeue : 1;                     // 0x0074 (0x0004) [0x0000000040000000] [0x00080000] (CPF_EditInlineNotify)
	unsigned long                                      TrainingNavigation : 1;                        // 0x0074 (0x0004) [0x0000000040000000] [0x00400000] (CPF_EditInlineNotify)
	unsigned long                                      TrainingManipulation : 1;                      // 0x0074 (0x0004) [0x0000000040000000] [0x00800000] (CPF_EditInlineNotify)
	unsigned long                                      FilterByColor : 1;                             // 0x0074 (0x0004) [0x0000000040000000] [0x02000000] (CPF_EditInlineNotify)
	unsigned long                                      Scoreboard : 1;                                // 0x0074 (0x0004) [0x0000000040000000] [0x04000000] (CPF_EditInlineNotify)
	unsigned long                                      DynamicMapEvents : 1;                          // 0x0074 (0x0004) [0x0000000040000000] [0x08000000] (CPF_EditInlineNotify)
	unsigned long                                      NameplateBoost : 1;                            // 0x0074 (0x0004) [0x0000000040000000] [0x20000000] (CPF_EditInlineNotify)
	unsigned long                                      EOSGameClips : 1;                              // 0x0074 (0x0004) [0x0000000040000000] [0x40000000] (CPF_EditInlineNotify)
	unsigned long                                      DynamicLogos : 1;                              // 0x0074 (0x0004) [0x0000000040000000] [0x80000000] (CPF_EditInlineNotify)
	unsigned long                                      XETagging : 1;                                 // 0x0078 (0x0004) [0x0000000040000000] [0x00000001] (CPF_EditInlineNotify)
	unsigned long                                      PlayMenuV4 : 1;                                // 0x0078 (0x0004) [0x0000000040000000] [0x00000002] (CPF_EditInlineNotify)
	unsigned long                                      QuickChatTimeStamp : 1;                        // 0x0078 (0x0004) [0x0000000040000000] [0x00000008] (CPF_EditInlineNotify)
	unsigned long                                      BundleProration : 1;                           // 0x0078 (0x0004) [0x0000000040000000] [0x00000010] (CPF_EditInlineNotify)
	unsigned long                                      TeamDemoAudio : 1;                             // 0x0078 (0x0004) [0x0000000040000000] [0x00000020] (CPF_EditInlineNotify)
