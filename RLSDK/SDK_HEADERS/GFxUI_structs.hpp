...
struct FLoadingMovieMapInfo
{
	...
	unsigned long                                      bSetBackgroundVisible : 1;                     // 0x0098 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bDisplayGenericBackground : 1;                 // 0x0098 (0x0004) [0x0000000000000000] [0x00000002] 
};
